...
public class HVUKPSPublicSoap
{
    ...
    public HVUKPSPublicSoap(){}

    public HVUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HVUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HVUExtendedSoapSerializationEnvelope envelope= new HVUExtendedSoapSerializationEnvelope(HVUExtendedSoapSerializationEnvelope.VER11);
