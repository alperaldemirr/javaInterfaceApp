...
public class HVUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HVUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HVUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HVUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HVUDateTimeConverter dateTimeConverter = new HVUStandardDateTimeConverter();

    public HVUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HVUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HVUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HVUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HVUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HVUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
